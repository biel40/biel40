...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-blue?style=for-the-badge&logo=linkedin)](tu-linkedin-url)
[![Email](https://img.shields.io/badge/Email-Contact-red?style=for-the-badge&logo=gmail)](mailto:tu-email)
...
Passionate Fullstack Web Developer specializing in building robust and scalable web applications. My main expertise lies in the **.NET ecosystem** for backend development and **Angular with TypeScript** for creating dynamic, responsive frontend experiences.
```typescript
const gabriel = {
    location: "Palma de Mallorca, Spain",
    currentFocus: [".NET Core", "Angular", "TypeScript", "Azure"],
    learning: ["Microservices", "Clean Architecture", "Azure DevOps"],
    askMeAbout: ["Web Development", "Backend Architecture", "Angular Best Practices"]
};
```
...
I'm always interested in connecting with fellow developers and discussing new projects or technologies. Feel free to reach out!
...
[![Portfolio](https://img.shields.io/badge/-Portfolio-000000?style=for-the-badge&logo=react&logoColor=white)](tu-portfolio-url)
